...
MFCApplication1Doc.h, MFCApplication1Doc.cpp - ドキュメント
    ...
    ドキュメントには次の文字列が含まれます。
        ファイル拡張子:      mfcapp1
        ファイルの種類の ID:        MFCApplication1.Document
        メイン フレームのキャプション:  MFCApplication1
        ドキュメントの種類の名前:       MFCApplication1
        フィルター名:         MFCApplication1 Files (*.mfcapp1)
        ファイルの新しい短い名前: MFCApplication1
        ファイルの種類の長い名前: MFCApplication1.Document
